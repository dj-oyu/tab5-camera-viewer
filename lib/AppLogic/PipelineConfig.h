...
constexpr uint32_t DECODE_BUF_COUNT = 2;  // ダブルデコードバッファ (JPEG/PPA並列用)
...
constexpr bool VERBOSE_PERF_LOG = true;          // Render/Fetch FPS periodic logs (diagnostic)
